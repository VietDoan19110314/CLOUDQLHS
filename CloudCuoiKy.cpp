...
ifstream docFileDanhSachHocVien("/home/ubuntu/environment/CLOUDQLHS/hocvien.txt");
...
void menu() {
	...
	cout << "10. Record the information students have added to the file /home/ubuntu/environment/CLOUDQLHS/hocvien.txt" << endl;
	cout << "11. Open file /home/ubuntu/environment/CLOUDQLHS/hocvien.txt and save to memory" << endl;
...
void ghiDuLieuHocVien(HocVien sv[],int &studentAdded) {
	ofstream ghiFileDanhSachHocVien("/home/ubuntu/environment/CLOUDQLHS/hocvien.txt",ios::out);
	for(int i = 0; i < studentAdded; i++) {
	...
	cout << "Recorded data successfully!! Go to /home/ubuntu/environment/CLOUDQLHS/hocvien.txt to check." << endl;
}
